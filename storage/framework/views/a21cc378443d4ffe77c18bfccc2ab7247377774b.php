...
<?php endif; ?>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('admin.home')).'','active' => request()->routeIs('admin.home')]]); ?>
...
<?php endif; ?>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown-imagenes">
                      <li><a class="dropdown-item" href="<?php echo e(route('admin.files.index')); ?>">Ver imagenes</a></li>
                      <li><a class="dropdown-item" href="<?php echo e(route('admin.files.create')); ?>">Crear imagenes</a></li>
                    </ul>
                  </li>
...
</nav><?php /**PATH C:\xampp\htdocs\imagenes\resources\views/navigation-menu.blade.php ENDPATH**/ ?>